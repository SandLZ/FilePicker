...
import com.handsmap.filepicker.ui.LFilePickerActivity;
...
public class LFilePicker {
    ...
    /**
     * 设置选择模式，0为文件选择模式，1为文件夹选择模式，2为全部 默认2
     *
     * @param chooseMode
     * @return
     */
    public LFilePicker withChooseMode(int chooseMode) {
        this.mChooseMode = chooseMode;
        return this;
    }

    public LFilePicker withMaxNumTips(String maxNumTips) {
        this.maxNumTips = maxNumTips;
        return  this;
    }

    public LFilePicker withBackText(String backText) {
    ...
    private Bundle getBundle() {
        ...
        paramEntity.setBackText(backText);
        paramEntity.setMaxNumTips(maxNumTips);
